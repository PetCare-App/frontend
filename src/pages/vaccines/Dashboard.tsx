...
export const Dashboard = ({
  ...
  const { vaccines, getVaccines, pets, successMessage, setSuccessMessage, deleteErrorMessage, setDeleteErrorMessage, deleteSuccessMessage, setDeleteSuccessMessage } =
    usePetCareContext();
