...
export const PetsHigiene = () => {
  ...
  useEffect(() => {
    !!isFormOpen &&  !!isCreate ? navigate('/higienes/create') : 
    !!isFormOpen &&  !isCreate ? navigate('/higienes/edit') :
  ...
  return (
    <Container sx={{display: 'flex', flexDirection:'column',}}>
      ...
      :
        <Form isCreate={isCreate} handleReturnButton={handleReturnButton} currentHigiene={higiene}></Form>
       }

       {
        !!isDeleteConfirmation && (
          ...
          <DialogActions>
            ...
            <Button onClick={() => handleDeleteHigieneButton(higiene.id)}>Deletar</Button>
          </DialogActions>
        </Dialog>
        )
       }
